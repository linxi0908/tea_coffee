                            ...
                            <form role="form" method="post" action="{{ route('admin.product.store') }}" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea placeholder="Nhập mô tả" class="form-control" name="description" id="description"></textarea>
                                        @error('description')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="custom-select">
                                            <option value="">---Vui lòng chọn---</option>
                                            <option {{ old('status') === '1' ? 'selected' : '' }} value="1">Hiển thị
                                            </option>
                                            <option {{ old('status') === '0' ? 'selected' : '' }} value="0">Ẩn
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="featured" class="custom-select">
                                            <option value="">---Vui lòng chọn---</option>
                                            <option {{ old('featured') === '1' ? 'selected' : '' }} value="1">Có
                                            </option>
                                            <option {{ old('featured') === '0' ? 'selected' : '' }}value="0">Không
                                            </option>
                                        </select>
                                        @error('featured')
                                            <div class="alert alert-danger">{{ $message }}</div>
